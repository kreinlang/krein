...
class Object_: DataType{
	...
	override DataType[string] __heap__(){ return this.supers; }

	override string __type__(){ return this.name; }

	override DataType[string] attrs(){ return this.attributes; }

	override string __str__(){ return this.attributes["__repr__"].__str__; }
...
class Class: DataType{
	...
	override string __type__(){ return "object"; }
	...
	override string __str__(){ return this.name ~ " (type)"; }
}
