...
class Utils: DataType{
	...
	override string __str__() { return "utils (builtin module)";}
}
...
class Print: DataType{
	...
	override string __str__(){ return "print (built-in function)"; }
}
...
class Attrs: DataType{
	...
	override string __str__(){ return "attrs (built-in function)"; }
}
...
class Readline: DataType{	
	...
	override string __str__(){ return "readline (built-in function)"; }
}
...
class Iter: DataType{
	...
	override string __str__(){ return "iter (builtin function)"; }
}


class Next: DataType{
	override DataType __call__(DataType[] params){ return params[0].__fetch__; }
	override string __str__(){ return "[Utils.Function #next]"; }
}
...
class Length: DataType{
	...
	override string __str__(){ return "super (built-in function)";}
}
...
class GetAttr: DataType{
	...
	override string __str__(){ return "getAttr (built-in function)";}
}
...
class Type: DataType{
	...
	override string __str__(){ return "type (built-in function)"; }
}
...
class Exit: DataType{
	...
	override string __str__(){ return "exit (built-in function)"; }
}
