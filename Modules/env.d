...
class Env: DataType{
	...
	override string __str__() { return "env (builtin module)";}
}
...
class Kill: DataType{
	...
	override string __str__() {return "kill (env method)"; }
}
...
class Stdin: DataType{
	...
	override string __str__() {return "stdin (env method)"; }
}
...
class Stderr: DataType{
	...
	override string __str__() {return "stderr (env method)"; }
}
...
class _Win32: DataType{
	...
	override string __str__() {return "win32 (env method)"; }
}
...
class _Arch: DataType{
	...
	override string __str__() {return "architecture (env method)"; }
}
...
class _Platform: DataType{
	...
	override string __str__() {return "platform (env method)"; }
}
