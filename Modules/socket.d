    ...
    override DataType __call__(DataType[] params){
        ...
        switch (params.length) {
            ...
            case (0):
                ...
                break;
            default:
                addr = getAddress(params[0].__str__, to!ushort(params[1].number2));
                break;
        }
...
DataType _AddressFamily(){
    return new Obj_("[Socket.Object: #addressfamily]", [
...
DataType _SocketType(){
    return new Obj_("[Socket.Object: #sockettype]", [
...
DataType _ShutDown(){
    return new Obj_("[Socket.Object #shutdown]", [
...
class GetProtoByName: DataType{
    override DataType __call__(DataType[] params){
        if (params.length){
            ...
            if (proto.getProtocolByName(params[0].__str__))
